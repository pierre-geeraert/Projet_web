...
INSERT INTO `utilisateurs` (`user_id`, `name`, `surname`, `email`, `password`, `status`) VALUES
...
ALTER TABLE `appreciate`
  ...
  ADD KEY `FK_appreciate_IdImages` (`IdImages`);
...
--
ALTER TABLE `appreciate`
  ADD CONSTRAINT `FK_appreciate_IdImages` FOREIGN KEY (`IdImages`) REFERENCES `images` (`IdImages`),
  ADD CONSTRAINT `FK_appreciate_IdUsers` FOREIGN KEY (`IdUsers`) REFERENCES `utilisateurs` (`IdUsers`);
